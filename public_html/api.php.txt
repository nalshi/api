...
// توليد المسار السري الخاص بهذا التاجر (نفس المعادلة الموجودة في التوكن)
$merchant_secret_hash = md5($merchant_id . APP_SECRET_KEY . 'orders');
sync_to_firebase($m_username, "secure_active_orders/$merchant_secret_hash", $ticket_id_for_alert, $fb_order_data, 'PUT');
                    }
